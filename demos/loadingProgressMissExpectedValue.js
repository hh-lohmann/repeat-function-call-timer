 ...
 *    - cf. loadingProgressMatchExpectedValue.js = Demo to *match* an expected value
 *  - For demonstrating functionality, not for direct application
 * @example loadingProgressMissExpectedValue(document.getElementById('myOutput'))
 ...
 */
export const loadingProgressMissExpectedValue = function(targetEl,onEnd=()=>{},stepSymbol='\u25A0',duration=3000,stepLength=100){
