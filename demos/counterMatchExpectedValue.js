 ...
 *    - cf. counterMissExpectedValue.js = Demo to *miss* an expected value
 *  - For demonstrating functionality, not for direct application
 * @example counterMatchExpectedValue(document.getElementById('myOutput'))
 ...
 */
export const counterMatchExpectedValue = function(targetEl,onEnd=()=>{},duration=3000,stepLength=100){
